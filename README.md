...
| **LilexKR Compact** | 528 | 1056 | O | O |
| **LilexKR 35** | 600 | 1000 | X (3:5 비율) | O |

한글이 주로 쓰이는 환경에서는 **LilexKR Compact**가, 주석 등의 제한적인 부분만 한글로 사용하는 환경에서는 **LilexKR Std** 혹은 **Lilex KR 35**를 사용하는 것이 가독성이 좋습니다. **LilexKR 35**는 **LilexKR Std**보다 한글의 자간이 좁아 가독성 측면에서 나으나, 완전한 1:2 비율 고정폭 글꼴이 아니기에 줄이 똑바르지 않은 곳이 존재할 수 있습니다.
...
허용 범위
 ...
 - 수정 및 재배포: 폰트의 글립을 수정하거나 다른 폰트와 병합하여 재배포할 수 있습니다.
